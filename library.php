...
class driver_field extends driver {
    ...
    function display_value(page $page, mode $mode, driver_record $parent) {//driver field
        //
...
class column_relation extends column {
    ...
    //hidden)
    function display_input_tag(page $page, mode $mode, driver_record $parent) {//column_relation
        //
        //Echo the input tag
        echo "<input";
        //
...
class column_primary extends column_relation {
    ...
    function display_input_tag(page $page, mode $modeIn, driver_record $parent) {//column_primary
    }
